...
public class WikidataClientConfiguration{
	 ...
	 * @return
	 */
	public static synchronized WikidataClientConfiguration getInstance() {
		singleton = new WikidataClientConfiguration();
	...
	//local attributes
		...
		private static WikidataClientConfiguration singleton;

		/**
		 * Hide the default constructor
		 */
		WikidataClientConfiguration() {
		}
